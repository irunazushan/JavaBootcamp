...
public class MessagesRepositoryImpl implements MessagesRepository<Message> {
    ...
    public Optional<Message> findById(Long id) {
        String query = "SELECT id, sender, message, sent_time FROM messages WHERE id = :id";
    ...
    public void save(Message entity) {
        String query = "INSERT INTO messages (sender, message) VALUES (:sender, :message) RETURNING id";
        SqlParameterSource namedParameters = new MapSqlParameterSource()
    ...
    public void update(Message entity) {
        String query = "UPDATE messages SET sender=:sender, message=:message, sent_time=:sent_time WHERE id=:id";
        SqlParameterSource namedParameters = new MapSqlParameterSource()
    ...
    public List<Message> getMessagesByUserId(Long id) {
        String query = "SELECT id, sender, message, sent_time FROM messages WHERE sender=:sender";
        SqlParameterSource namedParameters = new MapSqlParameterSource()
                .addValue("sender", id);
