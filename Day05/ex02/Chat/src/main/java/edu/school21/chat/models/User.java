...
public class User {
    ...
    public User(Long id, String login, String password, ArrayList<Chatroom> cr, ArrayList<Chatroom> scr) {
        this.id = id;
        this.login = login;
        this.password = password;
        createdRooms = cr;
        socializingChatrooms = scr;
    }
    ...
    public String toString() {
        return "{" +
                ...
                ", login=\"" + login + '"' +
                ", password=\"" + password + '"' +
                ", createdRooms=" + (!createdRooms.isEmpty()  ? createdRooms : "null") +
                ", rooms=" + (!socializingChatrooms.isEmpty()  ? socializingChatrooms : "null") +
                '}';
    }
}
